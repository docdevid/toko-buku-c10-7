...
<div class="row">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div class="d-flex align-items-center">
            <h6 class="display-6 fw-bold me-2">Iklan anda</h6>
            <a href="<?= site_url('member/iklan/new') ?>" class="btn btn-sm btn-success">Buat iklan baru</a>
        </div>
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                <li><a class="dropdown-item" href="<?= site_url('member/iklan') ?>">Semua Kategori</a></li>
                <?php foreach ($kategoriModel->find() as $kategori) : ?>
                    <li><a class="dropdown-item" href="<?= site_url('member/iklan/kategori/' . $kategori->id) ?>"><?= $kategori->kategori ?></a></li>
                <?php endforeach; ?>
            </ul>
        </div>
    </div>
            ...
            <div class="col-6 col-md-3 mb-4">
                <div class="card border-0 shadow">
                    ...
                    <div class="card-body text-center">
                        ...
                        <div>
                            <a href="<?= site_url('member/iklan/' . $iklan->id . '/edit') ?>" class="btn btn-sm text-success"><i class="bi bi-pencil"></i></a>
                            <form onSubmit="event.preventDefault();deleteHandler(this);" action="<?= base_url('member/iklan/' . $iklan->id) ?>" method="POST" class="form d-inline">
    ...
    <?php else : ?>
        <div class="col-12">
            <div class="alert alert-danger">
                ...
                <?php else : ?>
                    <i class="fa fa-info-circle"></i> Anda tidak memiliki iklan di kategori ini
                <?php endif; ?>
            </div>
        </div>
    <?php endif; ?>
