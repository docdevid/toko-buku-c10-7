        ...
        <div class="row p-0 p-md-4">
            ...
            <div class="col-12 col-md-4 order-1 order-md-0">
                <div class="d-flex justify-content-between align-items-center mb-2">
                    <a href="<?= route_to('admin/master/graph/new') ?>" class="btn btn-primary text-nowrap me-1"><i class="bi bi-plus-lg"></i> <span class="d-none d-xl-inline">Tambah</span></a>
                ...
                <div class="table-responsive mb-3">
                    <table class="table text-nowrap">
                        <tr>
                            <th scope="col">#</th>
                            <th scope="col">Lokasi Awal - Tujuan</th>
                            <th scope="col"></th>
                        </tr>
                        <?php
                        ...
                        <?php foreach ($graphs as $graph) : ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><a href="<?= base_url('admin/master/graph/' . $graph->id) ?>" class="text-decoration-none text-dark small">
                                        <span class="text-left"><?= word_limiter($graph->startName, 5, '..') ?></span><br />
                                        <span class="text-left"><?= word_limiter($graph->endName, 5, '..') ?></span>
                                    </a>
                                </td>
                                <td>
                                    <a href="<?= site_url('admin/master/graph/' . $graph->id . '/edit') ?>" class="btn btn-sm text-success"><i class="bi bi-pencil"></i></a>
                                    <form onSubmit="event.preventDefault();deleteHandler(this);" action="<?= base_url('admin/master/graph/' . $graph->id) ?>" method="POST" class="form d-inline">
