            ...
            <table class="table table-bordered table-striped table-sm text-nowrap">
                ...
                <?php foreach ($kategoris as $kategori) : ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?= site_url('admin/kategori/' . $kategori->id) ?>" class="btn btn-sm text-primary"><i class="bi bi-info-circle"></i></a>
                            <a href="<?= site_url('admin/kategori/' . $kategori->id . '/edit') ?>" class="btn btn-sm text-success"><i class="bi bi-pencil"></i></a>
                            <form onSubmit="event.preventDefault();deleteHandler(this);" action="<?= base_url('admin/kategori/' . $kategori->id) ?>" method="POST" class="form d-inline">
